...
```{r}
# acetate
acetate_long <- read_delim("Lab5/curated_data/SCFA_wkly_long.txt", 
    "\t", escape_double = FALSE, trim_ws = TRUE) %>%
  rename_all(tolower)%>%
  filter(semester != "Winter2015",
         quantity_compliant == "yes") %>%
...
```{r}
# propionate
propionate_long <- read_delim("Lab5/curated_data/SCFA_wkly_long.txt", 
    "\t", escape_double = FALSE, trim_ws = TRUE) %>%
  rename_all(tolower)%>%
  filter(semester != "Winter2015",
         quantity_compliant == "yes") %>%
...
```{r}
# pH
pH_long <- pH_wkly <- read_delim("Lab5/curated_data/pH_wkly.txt", 
    "\t", escape_double = FALSE, trim_ws = TRUE) %>%
  rename_all(tolower)%>%
  filter(semester != "Winter2015",
         quantity_compliant == "yes") %>%
